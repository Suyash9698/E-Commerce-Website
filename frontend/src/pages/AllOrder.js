...
const AllOrder = ()=>{
    const [data,setData] = useState([])
        ...
        <div className="text-lg font-semibold">
            Ordered by: <span className="font-normal">{item.email || "No email provided"}</span>
        </div>
                                                ...
                                                <div key={product.productId+index} className="flex gap-3 bg-slate-100">
                                                    ...
                                                    <div>
                                                     ...
                                                     <div className="flex items-center gap-5 mt-1">
                                                      ...
                                                      <div>Quantity: {product.quatity}</div>
                                                     </div>
                                                    </div>
                                                </div>
                                            )
                                ...
                                <div>
                                    <div className="text-lg font-medium"> Shipping Details: </div>
                                    {
                                        item.shipping_options.map((shipping,index)=>{
                                            return(
                                                <div key={shipping.shipping_rate} className="text-lg">
